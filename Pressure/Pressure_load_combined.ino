...
const int sens_1 = analogRead(A0);
const int sens_2 = analogRead(A1);
const int sens_3 = analogRead(A2);
const int sens_4 = analogRead(A3);
const int sens_5 = analogRead(A4);
const int sens_6 = analogRead(A5);
